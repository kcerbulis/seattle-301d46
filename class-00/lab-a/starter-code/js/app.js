...
function displayPics(){
  ...
  // Since let is block scoped, after the curly bracket block it does not exist as a variable that has an accessable scope, so consol loging it will bring up an error
  console.log(viewed);
